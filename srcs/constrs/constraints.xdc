...
set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {din[4]}]
set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {shift_TMR}]
...
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {din[5]}]
...
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports sdas]
...
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {din[0]}]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {din[2]}]
...
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {din[1]}]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33  PULLUP true} [get_ports {din[3]}]
