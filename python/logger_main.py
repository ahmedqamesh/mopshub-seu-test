...
class Logger(object):
    ...
    def _add_report_level(self, logger):
        logging.NOTSET = 25
        logging.addLevelName(logging.NOTSET, 'REPORT')
        logger.report = lambda msg, *args, **kwargs: logger.log(logging.NOTSET, colored.magenta(msg), *args, **kwargs)

    def _add_info_level(self, logger):
        logging.INFO = 20
        logging.addLevelName(logging.INFO, 'INFO')
        logger.report = lambda msg, *args, **kwargs: logger.log(logging.INFO, colored.green(msg), *args, **kwargs)
