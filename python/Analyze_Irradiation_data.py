...
#matplotlib.rcParams['legend.legendHandles.set_sizes'] = 10
...
def parameterhelp():
	...
	print "-r : Analyze PSPP registers and ADCs"
	print "--all : perform all analyzis"
	print "Argument: path to folder with data"

# Main function
if __name__ == '__main__':
	# get curretn working path
	...
	if len(args) < 1:
		error("No argument given! Need path to data folder")

	print args

	a = Analyzer.Analyzer(DEBUG=_debug)
