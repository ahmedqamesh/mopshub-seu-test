...
# module references:
# Encoder, Inverter, seu_shift_combined
...
user.org:user:scb_testmaster:1.0\
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins LMB_Clk] [get_bd_pins dlmb_bram_if_cntlr/LMB_Clk] [get_bd_pins dlmb_v10/LMB_Clk] [get_bd_pins ilmb_bram_if_cntlr/LMB_Clk] [get_bd_pins ilmb_v10/LMB_Clk]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set din [ create_bd_port -dir I -from 5 -to 0 din ]
  set dout [ create_bd_port -dir O -from 4 -to 0 dout ]
  ...
  set sclx2 [ create_bd_port -dir O sclx2 ]
  set sdam [ create_bd_port -dir O sdam ]
  set sdas [ create_bd_port -dir I sdas ]
  set sdas_dec [ create_bd_port -dir O sdas_dec ]
  set shift_TMR [ create_bd_port -dir I shift_TMR ]
  set shift_clk [ create_bd_port -dir O shift_clk ]
  set shift_data [ create_bd_port -dir O shift_data ]
  set shift_mode [ create_bd_port -dir O shift_mode ]
  set shift_simple [ create_bd_port -dir I shift_simple ]
  set shift_test_clk [ create_bd_port -dir I -type clk shift_test_clk ]
  set shift_test_din [ create_bd_port -dir I shift_test_din ]
  set shift_test_mode [ create_bd_port -dir I shift_test_mode ]
  set shift_test_simpleOut [ create_bd_port -dir O shift_test_simpleOut ]
  set shift_test_tmrOut [ create_bd_port -dir O shift_test_tmrOut ]
  set ss_enc_out [ create_bd_port -dir O -from 2 -to 0 ss_enc_out ]
  ...
  # Create instance: SEUtestIP3000_0, and set properties
  set SEUtestIP3000_0 [ create_bd_cell -type ip -vlnv BUW:BUW:SEUtestIP3000:1.2 SEUtestIP3000_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /SEUtestIP3000_0/S_AXI]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S_AXI_ACLK_FREQ_HZ {166666666} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT4_PORT {clk_out016} \
  ...
  # Create instance: scb_testmaster_0, and set properties
  set scb_testmaster_0 [ create_bd_cell -type ip -vlnv user.org:user:scb_testmaster:1.0 scb_testmaster_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /scb_testmaster_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins scb_testmaster_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins SEUtestIP3000_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  # Create port connections
  connect_bd_net -net Encoder_0_ss_enc_out [get_bd_ports ss_enc_out] [get_bd_pins Encoder_0/ss_enc_out]
  connect_bd_net -net Inverter_0_in_int [get_bd_pins Inverter_0/in_int] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net Inverter_0_out_ext [get_bd_ports dout] [get_bd_pins Inverter_0/out_ext]
  connect_bd_net -net Inverter_0_sclx2_inv [get_bd_ports sclx2] [get_bd_pins Inverter_0/sclx2_ext]
  connect_bd_net -net Inverter_0_sdam_inv [get_bd_ports sdam] [get_bd_pins Inverter_0/sdam_ext]
  connect_bd_net -net Inverter_0_sdas_int [get_bd_pins Inverter_0/sdas_int] [get_bd_pins scb_testmaster_0/sdas]
  connect_bd_net -net SEUtestIP3000_0_data [get_bd_ports shift_data] [get_bd_pins SEUtestIP3000_0/data]
  connect_bd_net -net SEUtestIP3000_0_mode [get_bd_ports shift_mode] [get_bd_pins SEUtestIP3000_0/mode]
  connect_bd_net -net SEUtestIP3000_0_shift_clk [get_bd_ports shift_clk] [get_bd_pins SEUtestIP3000_0/shift_clk]
  connect_bd_net -net TMR_0_1 [get_bd_ports shift_TMR] [get_bd_pins SEUtestIP3000_0/TMR]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Inverter_0/out_int] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_quad_spi_1_io0_o [get_bd_ports io0_o] [get_bd_pins axi_quad_spi_1/io0_o]
  connect_bd_net -net axi_quad_spi_1_ip2intc_irpt [get_bd_pins axi_quad_spi_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_quad_spi_1_sck_o [get_bd_ports sck_o] [get_bd_pins axi_quad_spi_1/sck_o]
  connect_bd_net -net axi_quad_spi_1_ss_o [get_bd_pins Encoder_0/ss_axi_i] [get_bd_pins axi_quad_spi_1/ss_o]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net clk_0_1 [get_bd_ports shift_test_clk] [get_bd_pins seu_shift_combined_0/clk_in]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out200] [get_bd_pins mig_7series_0/clk_ref_i]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins SEUtestIP3000_0/S_AXI_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_quad_spi_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out100] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins scb_testmaster_0/S_AXI_ACLK]
  connect_bd_net -net clk_wiz_0_clk_out016 [get_bd_pins axi_quad_spi_1/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out016]
  connect_bd_net -net clk_wiz_0_clk_out166 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out166] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins rst_clk_wiz_0_166M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked] [get_bd_pins rst_clk_wiz_0_166M/dcm_locked]
  connect_bd_net -net data_in_0_1 [get_bd_ports shift_test_din] [get_bd_pins seu_shift_combined_0/data_in]
  connect_bd_net -net din_1 [get_bd_ports din] [get_bd_pins Inverter_0/in_ext]
  connect_bd_net -net io1_i_1 [get_bd_ports io1_i] [get_bd_pins axi_quad_spi_1/io1_i]
  ...
  connect_bd_net -net mode_0_1 [get_bd_ports shift_test_mode] [get_bd_pins seu_shift_combined_0/mode]
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_166M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn1 [get_bd_pins SEUtestIP3000_0/S_AXI_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_1/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn] [get_bd_pins scb_testmaster_0/S_AXI_ARESETN]
  connect_bd_net -net rst_clk_wiz_0_166M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins rst_clk_wiz_0_166M/peripheral_aresetn]
  ...
  connect_bd_net -net scb_testmaster_0_sclx2 [get_bd_pins Inverter_0/sclx2_int] [get_bd_pins scb_testmaster_0/sclx2]
  connect_bd_net -net scb_testmaster_0_sdam [get_bd_pins Inverter_0/sdam_int] [get_bd_pins scb_testmaster_0/sdam]
  connect_bd_net -net scb_testmaster_0_sdas_dec [get_bd_ports sdas_dec] [get_bd_pins scb_testmaster_0/sdas_dec]
  connect_bd_net -net sdas_1 [get_bd_ports sdas] [get_bd_pins Inverter_0/sdas_ext]
  connect_bd_net -net seu_shift_combined_0_data_out [get_bd_ports shift_test_simpleOut] [get_bd_pins seu_shift_combined_0/data_out]
  connect_bd_net -net seu_shift_combined_0_data_outTMR [get_bd_ports shift_test_tmrOut] [get_bd_pins seu_shift_combined_0/data_outTMR]
  connect_bd_net -net simple_0_1 [get_bd_ports shift_simple] [get_bd_pins SEUtestIP3000_0/simple]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs SEUtestIP3000_0/S_AXI/reg0] SEG_SEUtestIP3000_0_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs scb_testmaster_0/S_AXI/reg0] SEG_scb_testmaster_0_reg0

  # validate bd to update uart parameters
  update_compile_order -fileset sources_1
  validate_bd_design

  # update baudrate of uart
  set_property -dict [ list \
